...
{
    public class UsersTeachersTestDbContext : DbContext
    {
        public UsersTeachersTestDbContext()
        {

        }

        public UsersTeachersTestDbContext(DbContextOptions<UsersTeachersTestDbContext> options)
            : base(options)
        {
        }
